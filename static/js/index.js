...
layui.config({
	...
	var form = layui.form,
		...
		tab = layui.bodyTab({
			...
			url : "../static/json/navs.json" //获取菜单json地址json/navs.json
		});
	...
	function showNotice(){
		layer.open({
	        ...
	        btn: ['火速围观'],
	        moveType: 1,
	        content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p>托托出品，必属精品</p></div>',
